                                    ...
                                    <div class="bg-white rounded-lg p-6 shadow-md">
                                        <div class="mb-4">
                                            ...
                                            <button class="mt-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded"
                                                id="editButton">Edit Information</button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="popup-content">
                                        ...
                                        <form class="space-y-4">
                                            <div>
                                                ...
                                                <input class="w-full border rounded px-3 py-2" type="text" id="newName"
                                            ...
                                            <div>
                                                ...
                                                <input class="w-full border rounded px-3 py-2" type="text"
                                                    id="newAddress" name="newAddress" required>
                                            </div>
                                            <div>
                                                <label class="block font-semibold" for="newPhoneNumber">New Phone
                                                    Number</label>
                                                <input class="w-full border rounded px-3 py-2" type="tel"
                                                    id="newPhoneNumber" name="newPhoneNumber" required>
                                            </div>
